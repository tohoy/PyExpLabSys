""" Driver for Pfeiffer, HISCROLL pumps """
import time
import logging
import serial
...
class PfeifferHiscroll(object):
    """ Driver for the Pfeiffer HISCROLL series of dry pumps """
    ...
    def comm(self, command):
        ...
        self.ser.write(('000' + command + '\r').encode('ascii'))
...
if __name__ == '__main__':
    PUMP = PfeifferHiscroll('/dev/ttyUSB3')
